...
{{--<div class="alert flex flex-row items-center bg-{{$color}}-200 p-5 rounded border-b-2 border-{{$color}}-300">--}} <!-- $attributes almacena todos los atributos no definidos en el constructor, por ejemplo class="mb-4" -->
    <div {{$attributes->merge(['class' => "alert flex flex-row items-center bg-$color-200 p-5 rounded border-b-2 border-$color-300"])}} <!-- lo mismo de arriba pero con unión de clases -->
